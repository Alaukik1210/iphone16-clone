...
export default function Home() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setIsLoading(false), 2000); // 2s loading
  ...
  return (
    <div className="max-w-screen">
      <AnimatePresence mode="wait">
        {isLoading ? (
          <motion.div key="loader" exit={{ opacity: 0 }} transition={{ duration: 1 }}>
            <PageLoader />
          </motion.div>
        ) : (
          <motion.div
          ...
          >
            ...
            <StayUpdated />
             <div
                  ...
                  className="min-h-[100%] bg-gradient-to-br from-black via-gray-900 to-black max-w-screen flex flex-col items-center justify-center p-8 relative overflow-hidden"
                >
                  {/* iPhone 16 Pro Text */}
                  <motion.div
